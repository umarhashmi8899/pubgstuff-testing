...
export function CartAuthForm({ total }: CartAuthFormProps) {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            toast({ title: "Welcome back!", description: "You can now proceed with checkout." });
        }
    };
    ...
    const handleSignupAndCheckout = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            toast({ title: "Account Created!", description: "You are now logged in and can proceed with checkout." });
        }
    };
