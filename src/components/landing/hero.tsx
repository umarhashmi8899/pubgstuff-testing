...
export default function Hero() {
  const [buttonText, setButtonText] = useState("Celebrate New UI");
  ...
  const buttonProps = buttonText === "Join Discord" 
    ? { asChild: true } 
    : { onClick: handleCelebrate };
  
  const ButtonContent = buttonText === "Join Discord"
    ? <Link href="https://discord.gg/PwbEZ7wa3v" target="_blank" rel="noopener noreferrer">{buttonText}</Link>
    : <>{buttonText}</>;
          ...
          <div className="grid grid-cols-1 gap-y-8 lg:items-center lg:grid-cols-2">
            <div className="text-center lg:text-left xl:col-span-1 md:px-8 lg:px-0 xl:pr-12">
              ...
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
               ...
               <Button size="lg" variant="outline" className="hover-shimmer-button w-full sm:w-auto" {...buttonProps}>
                  {ButtonContent}
               </Button>
              </div>
