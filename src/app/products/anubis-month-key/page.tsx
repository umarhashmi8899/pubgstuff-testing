...
import { useAuth } from "@/hooks/use-auth" // import useAuth for auth-dependent UI actions
...
export default function SingleProductPage() {
  ...
  const { user } = useAuth() // useAuth for auth-dependent UI actions
      ...
      <div className="flex min-h-screen flex-col bg-gray-50">
        ...
        <main className="flex-1 pt-24 md:pt-32">
          <div className="container mx-auto px-4 py-8">
            ...
            <RelatedProducts category="pc" currentProduct="Anubis Month Key" onPriceChange={handleRelatedPriceChange} />
          </div>
        </main>
        <Footer />
      </div>
