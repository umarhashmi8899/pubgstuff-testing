...
const images = [
    { id: 1, src: 'https://iili.io/KGC6QqP.jpg', alt: 'Main product image', aiHint: 'gaming character cinematic' },
                                ...
                                <TabsContent value="description" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                                    <div className="prose prose-gray max-w-none space-y-4">
                                        <div className="bg-[#F5EFFF] p-4 rounded-lg">
                                            ...
                                            <p>Whether you want more accurate aim, clearer visuals, or faster decision-making, Redeye Frozen Key delivers it all. This is the ultimate solution for PUBG Mobile players who want a reliable, secure, and affordable boost.</p>
                                        </div>
                                        ...
                                        <div className="bg-[#CDC1FF] p-4 rounded-lg">
                                            ...
                                            <p>Unlike ordinary cheats, Redeye Frozen Key is a professional PUBG Mobile enhancement designed with account safety in mind. It combines Silent Aimbot, ESP visuals, and precision tools with Antiban protection. For players who want to test Redeye's premium features safely at an affordable price, this is the perfect choice.</p>
                                        </div>
                                    </div>
                                </TabsContent>
