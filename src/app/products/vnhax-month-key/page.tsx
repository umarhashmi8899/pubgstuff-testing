...
import { RelatedProducts } from "@/components/related-products" // Import the RelatedProducts component
...
export default function SingleProductPage() {
  ...
  const isProductFavorited = isFavorited(productData.id)

  const handleBuyNow = () => {
    // Add main product to cart
    addToCart(productData, quantity)
    
    // Add all selected related products to cart
    ...
    const totalItems = quantity + selectedRelatedProducts.length
    toast({
      title: "Added to Cart",
      description: `${totalItems} item(s) have been added to your cart.`,
    })
    router.push("/cart")
  }
  ...
  const handleFavoriteClick = () => {
    ...
    if (isProductFavorited) {
      ...
      toast({
        ...
        description: `${productData.name} has been removed from your favorites.`,
      })
    } else {
      addToFavorites(productData)
      toast({
        title: "Added to Favorites",
        description: `${productData.name} has been added to your favorites.`,
      })
    }
  }
      ...
      <div className="flex min-h-screen flex-col bg-gray-50">
        ...
        <main className="flex-1 pt-24 md:pt-32">
          <div className="container mx-auto px-4 py-8">
                ...
                <TabsContent value="description" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                  <div className="prose prose-gray max-w-none space-y-4">
                    ...
                    <div className="bg-[#CDC1FF] p-4 rounded-lg">
                      <h3 className="font-headline font-bold text-xl mb-4">Why Choose {productData.name}?</h3>
                ...
                <TabsContent value="faqs" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="item-2">
                      ...
                      <AccordionContent>
                        Vnhax Month Key is designed for PUBG Mobile and includes an integrated emulator bypass for
            ...
            <RelatedProducts 
              category="pc" 
              currentProduct="Vnhax Month Key" 
