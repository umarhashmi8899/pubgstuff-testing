"use client";
// Updated to use Android-specific animated gradient text
...
import { AnimatedGradientTextAndroid } from "@/components/animated-gradient-text-android";
