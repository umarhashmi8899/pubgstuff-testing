...
import { useAuth } from "@/hooks/use-auth" // import useAuth to fix "useAuth is not defined" and enable auth-gated favorites
import { ScrollArea, ScrollBar } from "@/components/ui/scroll-area"

const RelatedProducts = dynamic(() => import("@/components/related-products").then((mod) => mod.RelatedProducts), {
  ssr: false,
})
...
export default function SingleProductPage() {
  ...
  const { user } = useAuth() // add user from useAuth for favorites/login checks
      ...
      <div className="flex min-h-screen flex-col bg-gray-50">
        ...
        <main className="flex-1 pt-24 md:pt-32">
          <div className="container mx-auto px-4 py-8">
                ...
                <TabsContent value="description" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                  <div className="prose prose-gray max-w-none space-y-4">
                    <div className="bg-[#F5EFFF] p-4 rounded-lg">
                      <p>
                        Anubis – Bypass is a professional PUBG Mobile enhancement tool built for players who want to
                        gain a sharp advantage in every match. With its advanced bypass technology, Anubis ensures a
                        seamless and secure experience while unlocking powerful in-game advantages.
                      </p>
                      <p>
                        Designed with precision and Antiban protection, Anubis allows you to dominate battles using its
                        unique mix of aiming assistance, ESP visuals, and secure bypass functionality. Whether you play
                        casually or aim for higher ranks, Anubis makes sure your gameplay remains smooth, smart, and
                        reliable.
                      </p>
                    </div>
                    ...
                    <div className="bg-[#CDC1FF] p-4 rounded-lg">
                      ...
                      <p>
                        Unlike regular cheats, Anubis – Bypass is engineered for long-term safety and performance. It
                        combines Silent Aimbot, advanced ESP, and a secure bypass system to give players a competitive
                        edge without compromising their account. For serious PUBG Mobile players who value both safety
                        and precision, Anubis is the ultimate choice.
                      </p>
                    </div>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="faqs" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="item-2">
                      ...
                      <AccordionContent>
                        Anubis is designed for PUBG Mobile and includes an integrated emulator bypass for smooth
                        performance on PC.
                      </AccordionContent>
                    </AccordionItem>
            ...
            <RelatedProducts category="pc" currentProduct="Anubis Week Key" onPriceChange={handleRelatedPriceChange} />
          </div>
        </main>
        <Footer />
      </div>
