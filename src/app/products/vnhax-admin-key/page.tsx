                  ...
                  <div>
                    <div className="bg-blue-50 border border-blue-200 text-blue-800 text-sm rounded-lg p-3 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1">
                          Price includes a small donation for orphans & the needy. You pay nothing extra.
                        </p>
                      </div>
                    </div>
                ...
                <TabsContent value="description" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                  <div className="prose prose-gray max-w-none space-y-4">
                    <div className="bg-[#F5EFFF] p-4 rounded-lg">
                      <p>
                        Vnhax Admin Key is a premium PUBG Mobile booster and ESP tool designed for players who want to
                      ...
                      <p>
                        ...
                        with skins and kill messages, Vnhax Admin Key delivers it all. This is the ultimate solution for
                        PUBG Mobile players who want a reliable, secure, and long-term booster.
                      </p>
                    </div>
                    ...
                    <div className="bg-[#CDC1FF] p-4 rounded-lg">
                      ...
                      <p>
                        Unlike ordinary cheats or hacks, Vnhax Admin Key is a professional PUBG Mobile booster built
                ...
                <TabsContent value="faqs" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="item-2">
                      ...
                      <AccordionContent>
                        Vnhax Admin Key is designed for PUBG Mobile and includes an integrated emulator bypass for
