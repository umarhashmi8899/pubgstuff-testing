...
import { useAuth } from "@/hooks/use-auth" // import useAuth for favorites/login checks

const images = [
  {
    id: 1,
    src: "https://iili.io/KGC6lsI.jpg",
  ...
  },
  {
    ...
    alt: "Product feature view",
    aiHint: "gaming action screenshot",
  },
...
const reviews = [
  {
    ...
    rating: 5,
    comment:
      "Absolutely game-changing! The ESP is flawless and the aimbot is incredibly precise. My K/D ratio has skyrocketed. 100% recommend!",
  },
  {
    name: "Samantha Bee",
    ...
    rating: 5,
    comment:
      "I was skeptical at first, but this is the real deal. The security is top-notch, and I've had zero issues with my main account. The support team is also very responsive.",
  },
  {
    name: "Mike Thompson",
    ...
    rating: 4,
    comment:
      "Great tool with lots of features. The recoil control is insane. My only suggestion would be to add more customization options for the visuals. Otherwise, it's perfect.",
  },
]
...
export default function SingleProductPage() {
  ...
  const { user } = useAuth() // useAuth for favorites/login checks
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[6fr,5fr] gap-8 md:gap-12 max-w-5xl mx-auto">
              ...
              <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 font-headline mt-1">
                      Vnhax iOS Frozen Key
                    </h1>
                ...
                <div className="aspect-square relative rounded-xl overflow-hidden shadow-inner bg-gray-50 flex items-center justify-center">
                  <Image
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="absolute top-3 left-3 bg-white/50 backdrop-blur-sm hover:bg-white/80 text-gray-700"
                  >
                    <Maximize className="w-5 h-5" />
                  </Button>
                </div>
                <div className="mt-4 hidden md:flex items-center justify-between">
                  <Button variant="outline" size="sm" className="bg-white" onClick={handleResetImage}>
                    <RefreshCw className="w-4 h-4 mr-2" /> Reset
                  </Button>
                  <div className="flex items-center gap-2">
                    <Button variant="outline" size="icon" onClick={prevThumbnails} className="h-8 w-8 bg-white">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      {visibleThumbnails.map((image) => (
                        <button
                          ...
                          className={`aspect-square w-16 relative rounded-md overflow-hidden border-2 transition-all flex items-center justify-center ${selectedImage.id === image.id ? "border-primary" : "border-gray-200 hover:border-primary/50"}`}
                        >
                          <Image
                    ...
                    <Button variant="outline" size="icon" onClick={nextThumbnails} className="h-8 w-8 bg-white">
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-200 flex-1 flex flex-col justify-between">
                  <div>
                    <div className="bg-blue-50 border border-blue-200 text-blue-800 text-sm rounded-lg p-3 flex items-start gap-3 mb-4">
                      ...
                      <p className="flex-1">
                        <b>Donation Included!</b> Price includes a small donation for orphans & the needy. You pay
                        nothing extra.
                      </p>
                    </div>
                    <div className="border border-gray-200 rounded-lg p-4">
                      ...
                      <p className="text-green-600 font-semibold">
                        {currency === "PKR" ? "Rs (Pakistani Rupees)" : "$ (United States Dollar)"}
                      </p>
                      <div className="mt-4">
                        <p className="text-sm text-gray-500 mb-2">
                          Add Extra Support ( {formatPrice(EXTRA_PRICE)} each )
                        </p>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                          <label
                            htmlFor="windows"
                            className="flex items-center space-x-2 border rounded-md p-2 hover:bg-gray-50 cursor-pointer has-[input:checked]:bg-primary/5 has-[input:checked]:border-primary transition-all"
                          >
                            <Checkbox
                              id="windows"
                              checked={extras.windows}
                              onCheckedChange={() => handleExtraChange("windows")}
                            />
                          ...
                          >
                            <Checkbox
                              id="drivers"
                              checked={extras.drivers}
                              onCheckedChange={() => handleExtraChange("drivers")}
                            />
                          ...
                          >
                            <Checkbox
                              id="extras"
                              checked={extras.extras}
                              onCheckedChange={() => handleExtraChange("extras")}
                            />
                  ...
                  <div className="mt-6">
                    <div className="flex justify-between items-center gap-4">
                      ...
                      <Button
                        size="lg"
                        className="flex-1 hover-shimmer-button bg-black text-white hover:bg-gray-800 rounded-lg"
                ...
                <TabsContent value="description" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                  <div className="prose prose-gray max-w-none space-y-4">
                    <div className="bg-[#F5EFFF] p-4 rounded-lg">
                      <p>
                        Vnhax Frozen Key is a premium PUBG Mobile booster and ESP tool designed for players who want to
                        gain a professional advantage in every match. With more than 13,000 satisfied users and a 4.9
                        rating, this product is proven to be safe, secure, and effective.
                      </p>
                      <p>
                        Built with advanced Antiban protection, Vnhax ensures your main account stays safe while you
                        enjoy features like Wall ESP, Loot ESP, Aimbot, Magic options, special kill effects, and recoil
                        control. It also comes with an integrated emulator bypass for smooth performance on PC.
                      </p>
                      <p>
                        Whether you want to spot enemies faster, improve shooting precision, or customize your gameplay
                        with skins and kill messages, Vnhax Frozen Key delivers it all. This is the ultimate solution
                        for PUBG Mobile players who want a reliable, secure, and long-term booster.
                      </p>
                    </div>
                    ...
                    <div className="bg-[#E5D9F2] p-4 rounded-lg">
                      ...
                      <ul className="space-y-2 list-disc pl-5">
                        <li>
                          100% Safe & Secure – Advanced Antiban technology keeps your PUBG Mobile main account safe.
                        </li>
                    ...
                    <div className="bg-[#CDC1FF] p-4 rounded-lg">
                      ...
                      <p>
                        Unlike ordinary cheats or hacks, Vnhax Frozen Key is a professional PUBG Mobile booster built
                        with long-term account safety in mind. It combines powerful features like ESP, Aimbot, recoil
                        control, and skins with a guaranteed Antiban system. For serious players who want to stay safe
                        while improving their gameplay, this is the best choice.
                      </p>
                    </div>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="faqs" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      ...
                      <AccordionContent>
                        Yes, it's 100% safe. Our product is equipped with advanced Antiban protection to ensure your
                        main account's security.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                      <AccordionTrigger>What platforms are supported?</AccordionTrigger>
                      <AccordionContent>
                        Vnhax Frozen Key is designed for PUBG Mobile and includes an integrated emulator bypass for
                    ...
                    <AccordionItem value="item-3">
                      ...
                      <AccordionContent>
                        Delivery is instant. You will receive your key and setup instructions via email immediately
                    ...
                    <AccordionItem value="item-4">
                      ...
                      <AccordionContent>
                        We offer 24/7 dedicated support via our Discord server and customer service channels to assist
