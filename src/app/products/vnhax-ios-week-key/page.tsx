...
const images = [
    { id: 1, src: 'https://iili.io/KGC6kq7.jpg', alt: 'Main product image', aiHint: 'gaming character cinematic' },
...
export default function SingleProductPage() {
    ...
    const handleBuyNow = () => {
        ...
        // Show toast notification with total items added
        const totalItems = 1 + selectedRelatedProducts.length;
        toast({
            title: "Added to Cart",
            description: `${totalItems} item${totalItems > 1 ? 's' : ''} added to cart`,
        });
            ...
            <div className="flex min-h-screen flex-col bg-gray-50">
                ...
                <main className="flex-1 pt-24 md:pt-32">
                    <div className="container mx-auto px-4 py-8">
                            ...
                            <div className="bg-white p-6 rounded-xl border border-gray-200 flex-1 flex flex-col justify-between">
                                    <div>
                                        <div className="bg-blue-50 border border-blue-200 text-blue-800 text-sm rounded-lg p-3 flex items-start gap-3 mb-4">
                                            ...
                                            <p className="flex-1">
                                                <b>Donation Included!</b> Price includes a small donation for orphans & the needy. You pay nothing extra.
                                            </p>
                                        </div>
                        ...
                        <RelatedProducts 
                            category="ios" 
                            currentProduct="Vnhax iOS Week Key" 
