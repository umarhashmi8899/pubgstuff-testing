...
const freeTools = [
  ...
  {
    title: 'Formi - AI Form Builder',
    category: 'Scripts & Code / PHP Scripts / AI',
    imageUrl: 'https://i.postimg.cc/HLWdj0Vp/1.jpg',
    aiHint: 'ai form builder interface',
    href: '/free-tools/formi-ai-form-builder',
    reviews: '3.2k reviews'
  },
  {
    title: 'Imaster Patient Records Management System',
    category: 'Scripts & Code / PHP Scripts / Healthcare',
    imageUrl: 'https://i.postimg.cc/63Y7y5W7/2.jpg',
    aiHint: 'patient records healthcare management',
    href: '/free-tools/imaster-patient-records',
    reviews: '2.8k reviews'
  },
  {
    title: 'Business Finance logo',
    category: 'Graphics / Logos / Marketing',
    imageUrl: 'https://i.postimg.cc/zfh6zVkg/3.jpg',
    aiHint: 'business finance logo vector',
    href: '/free-tools/business-finance-logo',
    reviews: '4.1k reviews'
  },
  {
    title: 'Letter A Logo Spark Bolt Logo Design Flash Logo',
    category: 'Graphics / Logos / Letter / A',
    imageUrl: 'https://i.postimg.cc/3JDgbmrC/4.jpg',
    aiHint: 'letter a spark bolt lightning logo design',
    href: '/free-tools/letter-a-spark-bolt-logo',
